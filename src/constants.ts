...
export const HOST_MESSAGES = [MESSAGE.HELLO, MESSAGE.CONTEXT, MESSAGE.RESPONSE, MESSAGE.GOTO] as const

/** And what the module says. */
export const MODULE_MESSAGES = [MESSAGE.READY, MESSAGE.REQUEST, MESSAGE.RESIZE, MESSAGE.WENT] as const
